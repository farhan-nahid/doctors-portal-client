                ...
                <div className="row py-5">
                    ...
                    <FooterCol key={4} menuTitle="Our Address" menuItems={ourAddress}> 
                        <ul className="social-media list-inline">
                            ...
                            <li className="list-inline-item"><a href="//instagram.com/farhan_ahmed_na_hid" target="-blank" ><FontAwesomeIcon className="icon" icon={faInstagram} /></a></li>
                        </ul>
                        <div className="mt-5">
                            <h6>Call now</h6>
                            <Button  variant='info' className="btn-color">+2025550295</Button>
                        </div>
                    </FooterCol>
                </div>
